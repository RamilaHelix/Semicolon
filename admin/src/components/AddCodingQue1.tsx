import { Grid, TextField, InputAdornment, Box, Typography, TextareaAutosize, Button, Dialog, DialogContent, DialogTitle, Switch } from "@mui/material";
...
const javaScriptSTD = `/* let's write some code 😈 */
  ...
  `
export default function AddCodingQue1(props) {
